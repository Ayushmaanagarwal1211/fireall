...
const Dashboard = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setMessage('');
console.log('sdsd')
const response = await fetch('http://127.0.0.1:5000/ufw/status', {
    method: 'POST',
    headers: {
        'Content-Type': 'application/json',
    },
    body: JSON.stringify({ portToDisable: "3000" }),
});
                ...
                <nav className="bg-light-gray-neon-p  h-14 flex items-center justify-between px-6 ">
                    ...
                    <div className="flex items-center space-x-4">
                        <button className="flex items-center gap-2  bg-blue-200 text-white px-4 py-2 rounded-md hover:bg-blue-500">
                            <FaDiscord onClick={handleSubmit} className="text-blue-600 text-sm" />
